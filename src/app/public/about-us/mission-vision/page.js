 ...
 * It renders within the global RootLayout and fetches data for the "mission-vision" slug.
...
class MissionVisionPage extends App {
    ...
    async loadPageData() {
        ...
        if (globalState.missionVisionPageData) {
            this.set('pageData', globalState.missionVisionPageData);
            this.render();
            return;
        }
    ...
    async fetchPageData() {
        try {
            ...
            if (response.data.success) {
                ...
                store.setState({ missionVisionPageData: pageData });
    ...
    async refreshData() {
        // Clear the cache
        store.setState({ missionVisionPageData: null });
                        ...
                        <div class="relative">
                            ...
                            <div class="relative w-full h-96">
                                <img src="${this.getImageUrl(this.getBannerImages(pageData)[0])}" 
                                     alt="Mission Vision Banner Image" 
                                        ...
                                        <div class="relative group">
                                            <div class="relative w-full h-32">
                                                <img src="${this.getImageUrl(imagePath)}" 
                                                     alt="Mission Vision Gallery Image ${index + 2}" 
