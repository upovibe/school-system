 ...
 * It renders within the global RootLayout and fetches data for the "our-team" slug.
...
class OurTeamPage extends App {
    ...
    async loadPageData() {
        ...
        if (globalState.ourTeamPageData) {
            this.set('pageData', globalState.ourTeamPageData);
            this.render();
            return;
        }
    ...
    async fetchPageData() {
        try {
            ...
            if (response.data.success) {
                ...
                store.setState({ ourTeamPageData: pageData });
    ...
    async refreshData() {
        // Clear the cache
        store.setState({ ourTeamPageData: null });
                                        ...
                                        <div class="relative group">
                                            <div class="relative w-full h-32">
                                                <img src="${this.getImageUrl(imagePath)}" 
                                                     alt="Our Team Gallery Image ${index + 2}" 
