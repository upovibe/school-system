 ...
 * 
 * This is the values aims page of the application.
 * It renders within the global RootLayout and fetches data for the "values-aims" slug.
...
class ValuesAimsPage extends App {
    ...
    async loadPageData() {
        ...
        if (globalState.valuesAimsPageData) {
            this.set('pageData', globalState.valuesAimsPageData);
            this.render();
            return;
        }
    ...
    async fetchPageData() {
        try {
            ...
            if (response.data.success) {
                ...
                store.setState({ valuesAimsPageData: pageData });
    ...
    async refreshData() {
        // Clear the cache
        store.setState({ valuesAimsPageData: null });
                                        ...
                                        <div class="relative group">
                                            <div class="relative w-full h-32">
                                                <img src="${this.getImageUrl(imagePath)}" 
                                                     alt="Values Aims Gallery Image ${index + 2}" 
