 ...
 * File-based routing: /about → app/public/about.js
 */
class AboutPage extends App {
    connectedCallback() {
        super.connectedCallback();
        document.title = 'About | UPO UI';
        this.loadPageData();
    }
    ...
    async loadPageData() {
        ...
        if (globalState.aboutPageData) {
            this.set('pageData', globalState.aboutPageData);
            this.render();
            return;
        }
    ...
    async fetchPageData() {
        try {
            ...
            if (response.data.success) {
                ...
                store.setState({ aboutPageData: pageData });
    ...
    async refreshData() {
        // Clear the cache
        store.setState({ aboutPageData: null });
                                        ...
                                        <div class="relative group">
                                            <div class="relative w-full h-32">
                                                <img src="${this.getImageUrl(imagePath)}" 
                                                     alt="About Gallery Image ${index + 2}" 
