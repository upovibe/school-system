...
class JuniorHighSchoolPage extends App {
    ...
    async loadPageData() {
        ...
        if (globalState.juniorHighSchoolPageData) {
    ...
    async fetchPageData() {
        try {
            const response = await api.get('/pages/slug/junior-high-school');
            if (response.data.success) {
                const pageData = response.data.data;
                
                // Cache the data in global store
                store.setState({ juniorHighSchoolPageData: pageData });
                        ...
                        <div class="relative">
                            ...
                            <div class="relative w-full h-96">
                                <img src="${this.getImageUrl(this.getBannerImages(pageData)[0])}" 
                                     alt="Junior High School Banner Image" 
                                        ...
                                        <div class="relative group">
                                            <div class="relative w-full h-32">
                                                <img src="${this.getImageUrl(imagePath)}" 
                                                     alt="Junior High School Gallery Image ${index + 2}" 
