...
class PrimarySchoolPage extends App {
    ...
    async loadPageData() {
        ...
        if (globalState.primarySchoolPageData) {
    ...
    async fetchPageData() {
        try {
            const response = await api.get('/pages/slug/primary-school');
            if (response.data.success) {
                const pageData = response.data.data;
                
                // Cache the data in global store
                store.setState({ primarySchoolPageData: pageData });
                        ...
                        <div class="relative">
                            ...
                            <div class="relative w-full h-96">
                                <img src="${this.getImageUrl(this.getBannerImages(pageData)[0])}" 
                                     alt="Primary School Banner Image" 
                                        ...
                                        <div class="relative group">
                                            <div class="relative w-full h-32">
                                                <img src="${this.getImageUrl(imagePath)}" 
                                                     alt="Primary School Gallery Image ${index + 2}" 
