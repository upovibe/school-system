...
class AdmissionsPage extends App {
    ...
    async loadPageData() {
        ...
        if (globalState.admissionsPageData) {
    ...
    async fetchPageData() {
        try {
            const response = await api.get('/pages/slug/admissions');
            if (response.data.success) {
                const pageData = response.data.data;
                
                // Cache the data in global store
                store.setState({ admissionsPageData: pageData });
                                        ...
                                        <div class="relative group">
                                            <div class="relative w-full h-32">
                                                <img src="${this.getImageUrl(imagePath)}" 
                                                     alt="Admissions Gallery Image ${index + 2}" 
