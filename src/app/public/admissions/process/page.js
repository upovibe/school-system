...
class AdmissionsProcessPage extends App {
    ...
    async loadPageData() {
        ...
        if (globalState.admissionsProcessPageData) {
    ...
    async fetchPageData() {
        try {
            const response = await api.get('/pages/slug/process');
            if (response.data.success) {
                const pageData = response.data.data;
                
                // Cache the data in global store
                store.setState({ admissionsProcessPageData: pageData });
                        ...
                        <div class="relative">
                            ...
                            <div class="relative w-full h-96">
                                <img src="${this.getImageUrl(this.getBannerImages(pageData)[0])}" 
                                     alt="Admissions Process Banner Image" 
                                        ...
                                        <div class="relative group">
                                            <div class="relative w-full h-32">
                                                <img src="${this.getImageUrl(imagePath)}" 
                                                     alt="Admissions Process Gallery Image ${index + 2}" 
