...
class AdmissionsRequirementsPage extends App {
    ...
    async loadPageData() {
        ...
        if (globalState.admissionsRequirementsPageData) {
    ...
    async fetchPageData() {
        try {
            const response = await api.get('/pages/slug/requirements');
            if (response.data.success) {
                const pageData = response.data.data;
                
                // Cache the data in global store
                store.setState({ admissionsRequirementsPageData: pageData });
                        ...
                        <div class="relative">
                            ...
                            <div class="relative w-full h-96">
                                <img src="${this.getImageUrl(this.getBannerImages(pageData)[0])}" 
                                     alt="Admissions Requirements Banner Image" 
                                        ...
                                        <div class="relative group">
                                            <div class="relative w-full h-32">
                                                <img src="${this.getImageUrl(imagePath)}" 
                                                     alt="Admissions Requirements Gallery Image ${index + 2}" 
