 ...
 * It renders within the global RootLayout and fetches data for the "community" slug.
...
class CommunityPage extends App {
    ...
    async loadPageData() {
        ...
        if (globalState.communityPageData) {
            this.set('pageData', globalState.communityPageData);
            this.render();
            return;
        }
    ...
    async fetchPageData() {
        try {
            ...
            if (response.data.success) {
                ...
                store.setState({ communityPageData: pageData });
    ...
    async refreshData() {
        // Clear the cache
        store.setState({ communityPageData: null });
                                        ...
                                        <div class="relative group">
                                            <div class="relative w-full h-32">
                                                <img src="${this.getImageUrl(imagePath)}" 
                                                     alt="Community Gallery Image ${index + 2}" 
