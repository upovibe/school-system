 ...
 * 
 * A modal component for viewing announcement details in the admin panel
 * 
 * Attributes:
 ...
 */
class AnnouncementViewModal extends HTMLElement {
    constructor() {
        super();
...
customElements.define('announcement-view-modal', AnnouncementViewModal);
