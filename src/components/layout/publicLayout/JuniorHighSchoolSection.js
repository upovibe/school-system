...
/**
 * Junior High School Section Component
 * 
 * Displays junior high school content with a unique design layout
 */
class JuniorHighSchoolSection extends App {
    constructor() {
        super();
    }
            ...
            return `
                <div class="text-center py-16">
                    <div class="bg-white rounded-lg shadow-sm p-8">
                        ...
                        <h2 class="text-xl font-medium text-gray-600 mb-2">Junior High School</h2>
                        <p class="text-gray-500">Our junior high school content is being prepared.</p>
                    </div>
                </div>
            `;
        }
                    ...
                    <div class="relative w-full h-[400px] overflow-hidden rounded-3xl mb-8">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="text-center text-white px-4">
                                <h1 class="text-2xl lg:text-3xl xl:text-4xl font-bold mb-2">Junior High School</h1>
                                <p class="text-base lg:text-lg opacity-90">Preparing students for higher education</p>
                            </div>
                        </div>
                    </div>
                ` : ''}
...
customElements.define('junior-high-school-section', JuniorHighSchoolSection);
export default JuniorHighSchoolSection; 