...
/**
 * Primary School Section Component
 * 
 * Displays primary school content with a unique design layout
 */
class PrimarySchoolSection extends App {
    constructor() {
        super();
    }
            ...
            return `
                <div class="text-center py-16">
                    <div class="bg-white rounded-lg shadow-sm p-8">
                        ...
                        <h2 class="text-xl font-medium text-gray-600 mb-2">Primary School</h2>
                        <p class="text-gray-500">Our primary school content is being prepared.</p>
                    </div>
                </div>
            `;
        }
                ...
                <div class="relative w-full h-[400px] overflow-hidden rounded-3xl mb-8">
                    ...
                    <div class="absolute inset-0 ${bannerImages.length > 0 ? 'hidden' : 'flex'} items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 rounded-3xl">
                        <div class="text-center text-gray-500">
                            ...
                            <p class="text-lg font-medium">Primary School Banner</p>
                        </div>
                    </div>
...
customElements.define('primary-school-section', PrimarySchoolSection);
