 ...
 * 
 * Displays values and aims content with a unique design layout
 */
class ValuesAimsSection extends App {
    constructor() {
        super();
    }
            ...
            return `
                <div class="text-center py-16">
                    <div class="bg-white rounded-lg shadow-sm p-8">
                        ...
                        <h2 class="text-xl font-medium text-gray-600 mb-2">Values & Aims</h2>
                        <p class="text-gray-500">Our values and aims content is being prepared.</p>
                    </div>
                </div>
            `;
        }
                    ...
                    <div class="relative w-full h-[400px] overflow-hidden rounded-3xl mb-8">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="text-center text-white px-4">
                                <h1 class="text-2xl lg:text-3xl xl:text-4xl font-bold mb-2">Values & Aims</h1>
                                <p class="text-base lg:text-lg opacity-90">Our core values and educational objectives</p>
                            </div>
                        </div>
                    </div>
                ` : ''}
...
customElements.define('values-aims-section', ValuesAimsSection);
export default ValuesAimsSection; 