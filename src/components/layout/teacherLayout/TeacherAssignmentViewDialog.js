                        ...
                        ${assignment.attachment_file ? `
                            <div class="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                                <div class="flex items-center justify-between">
                                    ...
                                    <ui-button variant="secondary" size="sm" onclick="(function(){const token=localStorage.getItem('token');if(token){window.open('/api/uploads/assignments/attachments/${assignment.attachment_file.split('/').pop()}?token='+encodeURIComponent(token),'_blank');}else{alert('Authentication required');}})()">
