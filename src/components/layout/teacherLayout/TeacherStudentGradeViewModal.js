...
class TeacherStudentGradeViewModal extends HTMLElement {
  ...
  render() {
    ...
    this.innerHTML = `
      <ui-modal ${this.hasAttribute('open') ? 'open' : ''} position="right" size="lg" close-button="true">
        <div slot="title">Grade Details (Teacher)</div>
...
customElements.define('teacher-student-grade-view-modal', TeacherStudentGradeViewModal);
export default TeacherStudentGradeViewModal;
